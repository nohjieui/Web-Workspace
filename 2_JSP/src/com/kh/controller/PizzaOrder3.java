...
/**
 * Servlet implementation class PizzaOrder3
 */
@WebServlet("/pizzaOrder3.do")
public class PizzaOrder3 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/views/PizzaPay3.jsp");
